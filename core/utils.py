        ...
        if class_name not in allowed_classes:
            ...
            if counted_classes != None:
                ...
                for key, value in counted_classes.items():
                    cv2.putText(image, "Vehicles detected: {}".format(value), (5, offset),
                            cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 0), 2)
                    offset += height_ratio
                    if(value>15):
                        TrafficIntensity = "High Traffic"
                    elif(value<15 & value>5):
                        TrafficIntensity = "Normal Traffic"
                    else: TrafficIntensity = "Light Traffic"
                    cv2.putText(image, TrafficIntensity, (5, offset),
                            cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 0), 2)
                    offset += height_ratio
